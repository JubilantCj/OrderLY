      ...
      <main className="main-content">
        ...
        {activePage === 'subscriptions' && (
          <div className="fade-in">
            ...
            {/* We moved our massive data table here so it only shows on the subscription page! */}
                  ...
                  <tbody>
                    {subscriptions.map((sub) => (
                      <tr key={sub.id} className="table-row">
                        ...
                        <td className="td-cost">${sub.cost.toFixed(2)}</td>
                        <td className="td-cycle">{sub.billingCycle}</td>
                        <td className="td-date">{sub.nextBillingDate}</td>
                        <td>
                        ...
                        <td>
                          <div className="impact-meter-wrapper">
                            ...
                            ></div>
                            <span className="impact-text">{sub.OrderLYImpactScore}/10</span>
                          </div>
                        </td>
                      </tr>
                    ))}
